...
[![Discord](https://img.shields.io/discord/1211424757279494176?style=flat-square&label=Discord)](https://discord.studygrc.org)

Welcome to the repository for the [Study GRC website](https://studygrc.org). This site serves as the central hub for our non-profit, connecting the community with free, accessible resources for Governance, Risk, and Compliance (GRC).
...
1. **Clone or download the repository:**
   ...
   ```
2. **Open the project folder:** Locate the `Study-GRC-Website` folder on your computer.
3. **View the site:** Simply double-click the `index.html` file to open it directly in your web browser. 
...
- **Submit a change:** Read our [Contributing Guidelines](CONTRIBUTING.md) to learn how to propose updates.
- **Join the community:** Connect with us in the [Study GRC Discord](https://discord.studygrc.org).
...
For the full legal details, please review the [LICENSE](LICENSE) file in this repository or visit the [official GNU GPLv3 page](https://www.gnu.org/licenses/gpl-3.0).
